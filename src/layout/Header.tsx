    ...
    return (
        <header className="bg-[#0f172a] text-white px-6 py-3 flex items-center justify-between">
            <div className="flex items-center gap-3">
                ...
                <div>
                    <div className="text-lg font-semibold tracking-wide">AGRICULTURAL STATISTICS</div>
            ...
            <div className="bg-[#0C272F] border border-[#065F46] rounded-full px-2.5 py-1.5 flex items-center justify-center">
                <span className="text-sm text-[#34d399] flex items-center justify-center gap-1">
                    <FcHighPriority className="text-lg" /> ข้อมูลผลผลิต พ.ศ. 2563-2567
                </span>
            </div>
        </header>
    );
