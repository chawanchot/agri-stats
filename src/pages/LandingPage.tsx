...
const storyData = [
    {
        ...
        description:
            "ซูม/เลื่อนดูแผนที่ประเทศไทย สลับแผนที่ได้ทั้งแบบถนนและดาวเทียม",
    },
    {
        tag: "FEATURE",
        title: "เปรียบเทียบผลผลิตรายจังหวัด",
        description:
            "เลือกพืชและปี แล้วดูการกระจายของผลผลิตบนแผนที่ด้วยแบ่งการระดับสี เปรียบเทียบรายจังหวัดพร้อมกราฟแสดงข้อมูล",
    },
    {
        tag: "FEATURE",
        title: "ตรวจสอบราคารับซื้อผลผลิต",
        description: "ดูจุดรับซื้อและราคาบนแผนที่",
    },
];
                ...
                <section className="w-full h-screen py-0 lg:py-20 relative flex flex-col justify-center items-center lg:block">
                    ...
                    <div ref={headerWrapRef} className="flex flex-col justify-center lg:h-full">
                        ...
                        <p className="mt-4 text-white/70 lg:w-1/2 text-xs md:text-sm">
                            ระบบแสดงข้อมูลสถิติทางการเกษตรผ่านเทคโนโลยีแผนที่ ดูผลผลิต เปรียบเทียบรายจังหวัด และตรวจสอบราคา
                        </p>
                    </div>
